...
public class AppWidget extends AppWidgetProvider {
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        PendingIntent pStarIntent = PendingIntent.getService(
                context,
                1,
                new Intent(context, EventObjectActionBridge.class)
                        .putExtra(EventObjectActionBridge.ACTION_CODE,
                                EventObjectActionBridge.ACTION_CHANGE_WIDGET_STAR),
                PendingIntent.FLAG_UPDATE_CURRENT
        );
        ...
        /*PendingIntent pAddIntent = PendingIntent.getActivity(
                ...
                new Intent(context, ActivityEditor.class)
                        .putExtra(EventObjectActionBridge.STATUE_IS_STARRED, false)
